...
public class KaKaoLoginController {
    ...
    public ResponseEntity<KakaoDTO> login(@RequestParam(value = "code", required = false) String code, HttpSession session){
        ...
        //return ResponseEntity.ok().headers(headers).body(sessionStore);
        KakaoDTO kakaoDTO = KakaoDTO.builder().k_name((String) session.getAttribute("userId")).build();
        return ResponseEntity.ok().headers(headers).body(kakaoDTO);
    }*/
    @GetMapping("/logout")
